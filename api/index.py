    ...
    try:
        ...
        for part in response.candidates[0].content.parts:
            if part.inline_data:
                ...
                # keep looping in case there’s also an image
        ...
        if image_base64:
            ...
            print("ERROR: No image data returned from model.")
            return jsonify({
                "error": "No image generated by the model.",
                "model_text_response": generated_text_response
            }), 500
